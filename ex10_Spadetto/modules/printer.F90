...
contains
   ...
   !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        write(dat, "(E55.5,' ',E55.5)") myr,myreal
        write(2,*) trim(adjustl(dat))
    ...
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        write(2, "(E55.5,E55.5,E55.5)") myr,myreal,myrealll

        close(2)
    END SUBROUTINE
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    !add line to file outfile as real   REAL
    SUBROUTINE wddddo(outfile, myr, myreal,myrealll,myreal2)
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        double precision , intent(IN) :: myreal,myr,myrealll,myreal2
        ...
        write(2, "(E55.5,E55.5,E55.5,E55.5)") myr,myreal,myrealll,myreal2
